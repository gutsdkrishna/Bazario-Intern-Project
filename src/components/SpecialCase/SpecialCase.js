  ...
  return (
    <div className="fixed top-52 right-2 z-20 hidden md:flex flex-col gap-2">
      <Link to="/signin">
        ...
        } w-16 h-[70px] rounded-md flex flex-col gap-1 ${
          darkMode ? 'text-indianYellow' : 'text-[#33475b]'
        } justify-center items-center shadow-testShadow overflow-x-hidden group cursor-pointer`}>
      ...
      <Link to="/cart">
        <div className={`${
          ...
          darkMode ? 'text-indianYellow' : 'text-[#33475b]'
        } justify-center items-center shadow-testShadow overflow-x-hidden group cursor-pointer relative`}>
          <div className="flex justify-center items-center">
